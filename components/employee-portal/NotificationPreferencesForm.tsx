...
const preferenceLabels: Array<{
...
}> = [
  {
    key: "leave",
    title: "Leave updates",
    description: "Approvals, rejections, and request changes.",
  },
  {
    key: "attendance",
    title: "Attendance updates",
    description: "Attendance correction decisions and reminders.",
  },
  {
    key: "announcements",
    title: "Company announcements",
    description: "Published company, policy, and people updates.",
  },
  {
    key: "payroll",
    title: "Payroll updates",
    description: "Payslip availability and payroll notices.",
  },
  {
    key: "email",
    title: "Email delivery",
    description: "Also send eligible notifications to your work email.",
  },
];
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <BellRing className="size-4" /> Notification preferences
        </CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-1">
          {preferenceLabels.map((preference) => (
            <label
              key={preference.key}
              className="flex cursor-pointer gap-3 rounded-lg p-3 hover:bg-muted/60"
            >
              <input
                type="checkbox"
